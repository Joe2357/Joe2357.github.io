...
카라추바 알고리즘은 [분할정복 알고리즘](https://joe2357.github.io/posts/Divide-and-Conquer/)을 통해 큰 수를 두 블록으로 쪼개서 계산하는 방법이다. 예시를 위해 두 큰 수 $a$와 $b$를 선언하자.  블록의 크기를 $T$라고 할 때, 두 수의 곱셈 $a \times b$는 아래와 같이 생각할 수 있다.  
