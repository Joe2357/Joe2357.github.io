...
tags: [Baekjoon]
uploaded_at: 2025-09-07 20:58:17 +0900
...
즉, 이 문제는 "수열을 분할하여 나눌 수 있는가"와 "각 수열의 길이를 미리 계산할 수 있는가", 그리고 "문자 $c$가 각 수열에서 어느 부분에 포함되어있는가"를 알아내면 해결할 수 있는 [분할정복 알고리즘](https://joe2357.github.io/posts/Divide-and-Conquer/) 문제이다.
...
>
> 참고 알고리즘 : [분할정복 알고리즘](https://joe2357.github.io/posts/Divide-and-Conquer/)